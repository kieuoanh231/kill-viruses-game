const data = [
  ...
  { hiragana: "一", romaji: "ichi" },
  { hiragana: "二", romaji: "ni" },
  { hiragana: "三", romaji: "san" },
  { hiragana: "四", romaji: "yon" },
  { hiragana: "五", romaji: "go" },
  { hiragana: "六", romaji: "roku" },
  { hiragana: "七", romaji: "nana" },
  { hiragana: "八", romaji: "hachi" },
  { hiragana: "九", romaji: "kyuu" },
];

const bossData = [
  { hiragana: "こんにちは", romaji: "konnichiha" },
  { hiragana: "おはよう", romaji: "ohayou" },
  { hiragana: "ありがとう", romaji: "arigatou" },
  { hiragana: "すみません", romaji: "sumimasen" },
  { hiragana: "こんばんは", romaji: "konbanha" },
  { hiragana: "ただいま", romaji: "tadaima" },
  { hiragana: "日本は大好きです", romaji: "nihonhadaisukidesu" },
  { hiragana: "ごめんなさい", romaji: "gomennasai" },
  { hiragana: "初めまして", romaji: "hajimemashite" },
  { hiragana: "さようなら", romaji: "sayounara" },
  { hiragana: "おやすみなさい", romaji: "oyasuminasai" },
  { hiragana: "お願いします", romaji: "onegaishimasu" },
];
